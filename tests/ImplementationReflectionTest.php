...
class ImplementationReflectionTest extends TestCase
{
    ...
    public function testImplementationWrongReturnType()
    {
        ...
        $this->expectExceptionMessage('Faulty service implementation. Expected return value of TS\Protobuf\SearchServiceNull::search() to be a Example\SearchResponse. Got NULL instead');
        $si->invoke('search', new SearchRequest());
    }
